...
class RegisterForm(FlaskForm):
    ...
    def validate_email_address(self, email_address_to_check):
        emai_address= User.query.filter_by(email_address=email_address_to_check.data).first()
        if emai_address:
            raise ValidationError('Email Adress already exist. Try a different email address')
